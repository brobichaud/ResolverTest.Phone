    ...
    public static class HashFactory
    {
        ...
        public static class Crypto
        {
            public static class SHA3
            {
                ...
                /// </summary>
                /// <param name="a_hashSize">224, 256, 384, 512</param>
                /// <param name="a_rounds">Greater than one</param>
                /// <param name="a_blockSize">1 <= blockSize <= 128</param>
                /// <returns></returns>
                public static IHash CreateCubeHash(HashLib.HashSize a_hashSize)
                {
                    switch (a_hashSize)
                    {
                ...
                /// <param name="a_hashSize">224, 256, 384, 512</param>
                /// <returns></returns>
                public static IHash CreateSHAvite3(HashLib.HashSize a_hashSize)
                {
                    switch (a_hashSize)
                    {
                ...
                /// <param name="a_hashSize">224, 256, 384, 512</param>
                /// <returns></returns>
                public static IHash CreateSIMD(HashLib.HashSize a_hashSize)
                {
                    switch (a_hashSize)
                    {
